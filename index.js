...
app.post('/upload',  function (req, res, next) {
  ...
  if(req.files){
        ...
        var q= "insert into image_db (level,img1,img2) values("+LEVEL+",'"+file1+"','"+file2+"'); ";
        var qalter="alter table image_db add img"+col_num+" varchar(1000) ,"+" add img"+col_num1+" varchar(1000);";
        var qupdate= "update image_db set img"+col_num+"="+"'"+file1+"',"+"img"+col_num1+"="+" '"+file2+"' "+"where level="+LEVEL;
